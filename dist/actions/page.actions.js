...
const generateFromTemplate = async (file, destination, payload) => {
    try {
        const data = fs_1.default.readFileSync(path_1.default.join(__dirname, "../../src/templates/page", file));
        const compiled = handlebars_1.default.compile(data.toString(), { noEscape: true });
        const output = compiled({
            outside: false,
            ...payload,
        });
        const dir = `${process.cwd()}/pages/[lang]/${destination}.tsx`;
